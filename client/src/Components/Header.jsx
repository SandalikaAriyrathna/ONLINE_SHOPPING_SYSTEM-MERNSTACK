...
export default function Header() {
  ...
  return (
    <header>
     <MDBNavbar expand='lg' light bgColor='secondary' style={{height:"70px"}}>
        <MDBContainer fluid>
          ...
          <MDBCollapse navbar >
            <MDBNavbarBrand style={{"fontSize":"50px","fontFamily":"Lucida Handwriting","color":"white"}}>WOZBY</MDBNavbarBrand>
            <MDBNavbarNav className='mb-2 mb-lg-0' style={{"fontSize":"20px" }}>
              <MDBNavbarItem>
              ...
              <MDBNavbarItem>
                <MDBNavbarLink href='/choosedress' className='text-light' >Choose Dress</MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem>
                <MDBNavbarLink  href='/contactus' className='text-light'>Contact Us</MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem>
                <MDBNavbarLink  href='/AboutUs' className='text-light' >About Us</MDBNavbarLink>
              </MDBNavbarItem>
              <form className='d-flex input-group w-auto' style={{marginLeft:"30px"}}>
            ...
            <div className='me-3'>
                        {
                            user ? (
                                <Link className="link" to="/stdprofile">
           ...
           <a href='/Login'>
            <button type="button" class="btn btn-dark btn-sm" style={{"marginRight":"10px", color:"white", width:"200px",height:"40px"}} >Login</button>
            </a>
            )}
    ...
    {user && <a href="/" class="btn btn-dark btn-sm" onClick={handleLogout} style={{"marginRight":"10px", color:"white", width:"200px",height:"40px"}}>LOGOUT</a>}
          ...
          <a href="/signup">
            <button type="button" class="btn btn-dark btn-sm" style={{"marginRight":"10px", color:"white", width:"200px",height:"40px"}}>SignUp</button>
            </a>
